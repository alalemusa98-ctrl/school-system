# 🎨 01. مواصفات ومكون هيدر صفحة الواجبات (`HomeworkHeader`)

> **الملف المرجعي:** [`Views-api/student/homeworks/01_HOMEWORK_HEADER.md`](file:///c:/Users/alhareth/Desktop/work/school-system/Views-api/student/homeworks/01_HOMEWORK_HEADER.md)  
> **اسم المكون البرمجي:** `HomeworkHeader.vue`  
> **الوصف:** الهيدر العلوي لصفحة الواجبات المدرسية الخاصة بالطالب (الجزء الأول المحدد بالمستطيل الأحمر في التصميم المعتمد)، ويشمل شريط الحالة بنمط iOS، زر الرجوع، عنوان الصفحة، زر الفلترة الجانبية، وكارت البروفايل الهيدر الملون الذي يحتوي على عنوان المتابعة، الصف والشعبة، الفصل الدراسي، والأيقونة 3D مع مؤشر الحالة التفاعلي.
...
2. **شريط العنوان الملاحة (Nav Bar):**
   ...
   - **عنوان الصفحة الرئيسي (Title):** text `"تفاصيل الواجبات"` بظلال وتأثير متألق.
   - **زر الفلترة الجانبية (Left Filter Button):** زر دائري زجاجي لأيقونة الفلترة التفاعلية.
3. **بطاقة الهيدر الرئيسية (Hero Banner Card):**
   - **العنوان الرئيسي:** `"متابعة الواجبات والحلول النموذجية"`.
   - **بيانات الطالب والأكاديميا:** `"الصف الخامس - الشعبة (أ5)"` باللون البنفسجي المتميز.
   - **الفصل الدراسي:** `"الفصل الدراسي الأول 2026"`.
   - **أيقونة الكتب 3D:** صورة 3D تفاعلية لمجموعة كتب دراسية تحتوي على مؤشر أخضر مضيء في الزاوية المباشرة (Active Status Dot).

---

## 📐 2. كود المكون الكامل Vue 3 Component (`HomeworkHeader.vue`)

```vue
<template>
  <header class="hw-header-wrapper">
...
## ⚙️ 3. الـ Props و الـ Events الخاصة بـ `HomeworkHeader`

| اسم الـ Prop / Event | النوع | الوصف | القيمة الافتراضية |
| :--- | :--- | :--- | :--- |
| `title` | `String` | عنوان الهيدر في شريط الملاحة | `"تفاصيل الواجبات"` |
| `subtitle` | `String` | العنوان داخل كارت الهيرو الأبيض | `"متابعة الواجبات والحلول النموذجية"` |
