    ...
    <div class="ios-hero-card animate-fade-in">
      ...
      <div class="hero-illustration-wrapper">
        <div class="hero-3d-box">
          <img :src="examImg || '/images/exams_evaluations_3d.png'" class="exams-3d-img" alt="امتحانات 3D" />
...
const props = defineProps({
  ...
  subtitle: { type: String, default: 'مواعيد الاختبارات والحلول الاسترشادية' },
...
.ios-hero-card {
  ...
  justify-content: space-between;
  color: #1e293b;
  box-shadow: 0 20px 45px -10px rgba(225, 29, 72, 0.22), 0 4px 16px rgba(0, 0, 0, 0.04);
...
.hero-3d-box {
  ...
  justify-content: center;
  position: relative;
  box-shadow: inset 0 2px 4px rgba(255, 255, 255, 0.8), 0 8px 18px rgba(225, 29, 72, 0.18);
