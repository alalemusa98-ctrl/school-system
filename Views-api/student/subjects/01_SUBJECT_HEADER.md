# 🎨 01. مواصفات ومكون هيدر صفحة المواد الدراسية (`SubjectHeader`)

> **الملف المرجعي:** [`Views-api/student/subjects/01_SUBJECT_HEADER.md`](file:///c:/Users/alhareth/Desktop/work/school-system/Views-api/student/subjects/01_SUBJECT_HEADER.md)  
> **اسم المكون البرمجي:** `SubjectHeader.vue`  
> **الوصف:** الهيدر العلوي لصفحة المواد المنهجية الدراسية الخاصة بالطالب (الجزء الأول في التصميم المعتمد)، ويشمل شريط الحالة بنمط iOS، زر الرجوع، عنوان الصفحة الرئيسي، زر التصفية الجانبية، وكارت البروفايل الهيدر الملون الذي يحتوي على عنوان المنهج والمقررات، الصف والشعبة، الفصل الدراسي، والأيقونة 3D المخصصة للمواد الدراسية مع مؤشر الحالة التفاعلي.
...
|  +-----------------------------------------------------------------+  |
|  |                                                                 |  |
|  |   قائمة المواد والأقسام الدراسية                            [ 📖 ] |  |
|  |   المقررة                                                🟢    |  |
...
2. **شريط العنوان الملاحة (Nav Bar):**
   ...
   - **عنوان الصفحة الرئيسي (Title):** text `"المواد الدراسية"` أو `"تفاصيل مادة [الرياضيات]"` بظلال وتأثير متألق.
   - **زر الفلترة الجانبية (Left Filter Button):** زر دائري زجاجي لأيقونة الفلترة التفاعلية.
3. **بطاقة الهيدر الرئيسية (Hero Banner Card):**
   - **العنوان الرئيسي:** `"قائمة المواد والأقسام الدراسية المقررة"`.
   - **بيانات الطالب والأكاديميا:** `"الصف الخامس - الشعبة (أ5)"` باللون السماوي والأزرق المتميز.
   - **الفصل الدراسي:** `"الفصل الدراسي الأول 2026"`.
   - **أيقونة المواد 3D:** صورة 3D تفاعلية لكتاب مدرسي وأيقونة المنهج تحتوي على مؤشر أخضر مضيء في الزاوية المباشرة (Active Status Dot).

---

## 📐 2. كود المكون الكامل Vue 3 Component (`SubjectHeader.vue`)

```vue
<template>
  <header class="subject-header-wrapper">
    ...
    <div class="subject-nav-bar">
      ...
      <h1 class="subject-page-title">{{ title }}</h1>
...
const props = defineProps({
  title: {
    type: String,
    default: 'المواد الدراسية'
  },
  subtitle: {
    type: String,
    default: 'قائمة المواد والأقسام الدراسية المقررة'
  },
  gradeSection: {
    type: String,
...
.hero-3d-box {
  ...
  justify-content: center;
  font-size: 32px;
  box-shadow: inset 0 2px 4px rgba(255, 255, 255, 0.8), 0 8px 16px rgba(2, 132, 199, 0.15);
  position: relative;
}
...
## ⚙️ 3. الـ Props و الـ Events الخاصة بـ `SubjectHeader`

| اسم الـ Prop / Event | النوع | الوصف | القيمة الافتراضية |
| :--- | :--- | :--- | :--- |
| `title` | `String` | عنوان الهيدر في شريط الملاحة | `"المواد الدراسية"` |
| `subtitle` | `String` | العنوان داخل كارت الهيرو الأبيض | `"قائمة المواد والأقسام الدراسية المقررة"` |
