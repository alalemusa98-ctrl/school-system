    ...
    <div class="ios-hero-card animate-fade-in">
      ...
      <div class="hero-illustration-wrapper">
        <div class="hero-3d-box">
          <img :src="subjectImg || '/images/homework_assignments_3d.png'" class="subjects-3d-img" alt="مواد 3D" />
...
const props = defineProps({
  title: { type: String, default: 'المواد الدراسية' },
  subtitle: { type: String, default: 'المناهج والملخصات التعليمية المتاحة' },
...
.ios-hero-card {
  ...
  justify-content: space-between;
  color: #1e293b;
  box-shadow: 0 20px 45px -10px rgba(14, 165, 233, 0.22), 0 4px 16px rgba(0, 0, 0, 0.04);
