<template>
  <section class="hw-filter-section">
    <!-- Segmented Control Tab Switcher (Matching Student Reference Design) -->
    ...
    <!-- Vertical Class/Section Pills Row (Matching Student Reference Design) -->
