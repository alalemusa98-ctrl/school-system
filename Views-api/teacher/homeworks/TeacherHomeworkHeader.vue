<template>
  <header class="ios-header">
    ...
    <!-- Floating Overlapping Hero Card (Matching Student Reference Design) -->
...
const props = defineProps({
  title: {
    type: String,
    default: 'إدارة الواجبات'
  },
  subtitle: {
    type: String,
    default: 'متابعة ونشر الواجبات المدرسية'
  },
  teacherName: {
    type: String,
    default: 'أ. أحمد سالم'
  ...
  subjectSpecialty: {
    type: String,
    default: 'معلم الرياضيات'
  },
  assignedSectionsText: {
    type: String,
    default: 'الصف 5 (أ5 ، ب5)'
  },
  semesterInfo: {
    type: String,
