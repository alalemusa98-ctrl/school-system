# 🎨 01. مواصفات ومكون هيدر صفحة المواد للمعلم (`TeacherSubjectHeader`)

> **الملف المرجعي:** [`Views-api/teacher/subjects/01_SUBJECT_HEADER.md`](file:///c:/Users/alhareth/Desktop/work/school-system/Views-api/teacher/subjects/01_SUBJECT_HEADER.md)  
> **اسم المكون البرمجي:** `TeacherSubjectHeader.vue`  
> **التصميم المرجعي المعتمد:** مطابق 100% لمواصفات [`Views-api/student/subjects/01_SUBJECT_HEADER.md`](file:///c:/Users/alhareth/Desktop/work/school-system/Views-api/student/subjects/01_SUBJECT_HEADER.md)  
> **الوصف:** الهيدر العلوي بنمط iOS 18 مع الجزيرة التفاعلية (Dynamic Island)، وشريط العنوان وزر الرجوع، وبطاقة الهيرو البيضاء العائمة المتداخلة (`ios-hero-card`) مع مؤشر الحالة الحي وصورة المواد ثلاثية الأبعاد (3D).
...
## 📐 2. كود المكون الكامل Vue 3 Component (`TeacherSubjectHeader.vue`)
  ...
  <header class="ios-header">
    ...
    <div class="ios-header-banner">
      ...
      <div class="subj-nav-bar">
        ...
        <h1 class="subj-page-title">{{ title }}</h1>

        <button class="nav-icon-btn filter-btn" @click="$emit('open-filter')" title="تصفية المقررات">
    ...
    <div class="ios-hero-card animate-fade-in">
      ...
      <div class="hero-illustration-wrapper">
        <div class="hero-3d-box">
          <img :src="heroImage || subjectImg || '/images/homework_assignments_3d.png'" class="subjects-3d-img" alt="مواد 3D" />
...
import subjectImg from '@/assets/homework_assignments_3d.png';

const props = defineProps({
  title: { type: String, default: 'الفصول الدراسية' },
  subtitle: { type: String, default: 'إدارة ومتابعة الفصول والشعب المسندة' },
  teacherName: { type: String, default: 'أ. أحمد سالم' },
  subjectSpecialty: { type: String, default: 'معلم الرياضيات' },
  assignedSectionsText: { type: String, default: '3 فصول وشعب مسندة' },
